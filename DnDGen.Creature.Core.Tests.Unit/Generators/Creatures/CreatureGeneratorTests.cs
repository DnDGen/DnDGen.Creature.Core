...
using DnDGen.Creature.Core.Templates;
using DnDGen.Creature.Core.Verifiers;
using DnDGen.Creature.Core.Verifiers.Exceptions;
...
{
    [TestFixture]
    public class DnDGen.Creature.CoreeratorTests
    {
        ...
        private IDnDGen.Creature.Coreerator DnDGen.Creature.Coreerator;
        ...
        public void Setup()
        {
            ...
            DnDGen.Creature.Coreerator = new DnDGen.Creature.Coreerator(
        ...
        public void InvalidCreatureTemplateComboThrowsException()
        {
            ...
            Assert.That(() => DnDGen.Creature.Coreerator.Generate("creature", "template"), Throws.InstanceOf<IncompatibleCreatureAndTemplateException>());
        }

        [Test]
        public void GenerateCreatureName()
        {
            var creature = DnDGen.Creature.Coreerator.Generate("creature", "template");
        ...
        public void GenerateAdvancedBarghestHitPoints()
        {
            ...
            var creature = DnDGen.Creature.Coreerator.Generate(CreatureConstants.Barghest, CreatureConstants.Templates.None);
            Assert.That(creature.HitPoints, Is.EqualTo(hitPoints));
        ...
        public void GenerateAdvancedGreaterBarghestHitPoints()
        {
            ...
            var creature = DnDGen.Creature.Coreerator.Generate(CreatureConstants.Barghest_Greater, CreatureConstants.Templates.None);
            Assert.That(creature.HitPoints, Is.EqualTo(hitPoints));
            Assert.That(creature.HitPoints.HitDiceQuantity, Is.EqualTo(newHitDiceQuantity));
            Assert.That(creature.HitPoints.HitDie, Is.EqualTo(90210));
            Assert.That(creature.HitPoints.DefaultTotal, Is.EqualTo(68));

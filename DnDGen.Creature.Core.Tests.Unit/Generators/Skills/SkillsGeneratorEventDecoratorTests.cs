...
namespace DnDGen.Creature.Core.Tests.Unit.Generators.Skills
{
    [TestFixture]
    public class SkillsGeneratorEventDecoratorTests
    {
        ...
        public void LogEventsForSkillsGeneration()
        {
            ...
            mockEventQueue.Verify(q => q.Enqueue("DnDGen.Creature.Core", $"Generating skills for creature"), Times.Once);
            mockEventQueue.Verify(q => q.Enqueue("DnDGen.Creature.Core", $"Generated 2 skills"), Times.Once);
        }
